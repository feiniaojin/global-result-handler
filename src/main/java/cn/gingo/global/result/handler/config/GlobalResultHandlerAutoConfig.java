...
import cn.gingo.global.result.handler.checkers.SwaggerSupportChecker;
...
public class GlobalResultHandlerAutoConfig {
    ...
    @Bean
    public SupportCheckerHolder checkFilterChain() {
        return new SupportCheckerHolder();
    }

    @Bean
    @ConditionalOnClass(name = "springfox.documentation.swagger2.web.Swagger2Controller")
    public SupportChecker swaggerSupportChecker(SupportCheckerHolder supportCheckerHolder) {
        SwaggerSupportChecker swaggerSupportChecker = new SwaggerSupportChecker();
        supportCheckerHolder.addSupportChecker(swaggerSupportChecker);
        return swaggerSupportChecker;
    }
